  ...
  describe "two equal entities" do
    ...
    describe "message sending" do
      ...
      it "should create proper mails" do
        #Sender Mail
        mail = MailboxerMongoid::Receipt.recipient(@entity1).notification(@message1).first
        assert mail
        if mail
        ...
        #Receiver Mail
        mail = MailboxerMongoid::Receipt.recipient(@entity2).notification(@message1).first
        assert mail
        if mail
    ...
    describe "message replying to sender" do
      ...
      it "should create proper mails" do
        #Sender Mail
        mail = MailboxerMongoid::Receipt.recipient(@entity2).notification(@message2).first
        assert mail
        if mail
          mail.is_read.should==true
          mail.trashed.should==false
        ...
        #Receiver Mail
        mail = MailboxerMongoid::Receipt.recipient(@entity1).notification(@message2).first
        assert mail
        if mail
          mail.is_read.should==false
          mail.trashed.should==false
  ...
  describe "three equal entities" do
    ...
    describe "message sending" do
      ...
      it "should create proper mails" do
        ...
        @recipients.each do |receiver|
          mail = MailboxerMongoid::Receipt.recipient(receiver).notification(@message1).first
          assert mail
          if mail
            mail.is_read.should==false
            mail.trashed.should==false
    ...
    describe "message replying to sender" do
      ...
      it "should create proper mails" do
        ...
        #No Receiver, No Mail
        mail = MailboxerMongoid::Receipt.recipient(@entity3).notification(@message2).first
        assert mail.nil?
    ...
    describe "message replying to all" do
      ...
      it "should create proper mails" do
        ...
        @recipients2.each do |receiver|
          mail = MailboxerMongoid::Receipt.recipient(receiver).notification(@message2).first
          assert mail
          if mail
            mail.is_read.should==false
            mail.trashed.should==false
